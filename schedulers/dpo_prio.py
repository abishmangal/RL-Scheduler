...
class DPOPriority(Scheduler):
    """
    Priority scheduler driven by a DPO-trained FeedForwardNN actor.
    ...
    def __init__(self, data, **kwargs):
        ...
        model_path = kwargs.get('model_path', 'model_weights/dpo_scheduler_dataset3_30context.pt')
        ...
        self.model.eval()
        print(f"[DPOPriority] Loaded weights from: {model_path}")
    ...
    def run(self):
        ...
        # FIX: wait time and aging tracking — matches env, ml_prio, dqn_prio
        self.wait_since        = {}
        self.total_wait        = {}
